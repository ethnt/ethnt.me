...
In terms of side projects, right now I'm working on improving the way we plan and organize our travel with a new product called Drift. I also created a compiler and interpreter for a toy programming language called [Marvin](https://github.com/ethnt/marvin).
