...
I’m also a web developer that works primarily with Ruby, JavaScript, and occasionally Haskell. I’ve beek working in the web field for six years, but currently I’m an intern at [Oak](http://oak.is), working on [Siteleaf](http://siteleaf.com) and it’s documentation site [Siteleaf Learn](http://learn.siteleaf.com). I’m also a founder and web developer at [Ramona](http://ramona.clothing), a new fashion collaboration product. Previously, I was the Chief Information Officer for the [Marist College Student Government Association](http://sga.marist.edu) and a web developer at [Fanzter](http://en.wikipedia.org/wiki/Fanzter).
